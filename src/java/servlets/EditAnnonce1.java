 ...
 * @author pj
 */
public class EditAnnonce1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EditAnnonce1</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EditAnnonce1 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
        ...
        RequestDispatcher dispatch = request.getRequestDispatcher("./scripts/editannonce1.jsp");
        dispatch.forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("typeEnvoi")!=null) {
            formulaire.setTypeEnvoi(Integer.parseInt(request.getParameter("typeEnvoi")));
            session.setAttribute("typeEnvoi", formulaire.getTypeEnvoi());
