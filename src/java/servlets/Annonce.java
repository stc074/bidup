...
public class Annonce extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Annonce</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Annonce at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("id")==null||request.getParameter("id").length()==0)
            ...
            Ann annonce=new Ann(idAnnonce);
            HttpSession session=request.getSession(true);
            session.setAttribute("uriAnnonce", annonce.getUri());
