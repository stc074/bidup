 ...
 * @author pj
 */
public class ChangeRegion1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ChangeRegion1</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ChangeRegion1 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
        ...
        if(request.getParameter("id")==null||request.getParameter("id").length()==0)
            ...
            try {
                ...
                out.println("<div>Departement :</div>");
                out.println("<select name=\"idDepartement\" onchange=\"changeDepartement1(this.value);\">");
                ...
                Logger.getLogger(ChangeRegion1.class.getName()).log(Level.SEVERE, null, ex);
