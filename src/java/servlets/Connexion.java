...
public class Connexion extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            if(this.formulaire==null)
                this.formulaire=new ConForm1();
            request.setAttribute("formulaire", this.formulaire);
            RequestDispatcher dispatch = request.getRequestDispatcher("./scripts/connexion.jsp");
    ...
    throws ServletException, IOException {
        ...
        this.formulaire.verifCnx1(request, response);
        processRequest(request, response);
    }
