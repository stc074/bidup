...
<link href="./CSS/style.css" type="text/css" rel="stylesheet" />
    ...
    case 1: %>
            ...
            break; } } else {
        int paypal=Integer.parseInt(request.getAttribute("paypal").toString()); %>
        <h1>Retour de paypal</h1><%
        switch(paypal) {
            case 1: %>
            <div class="info">Transaction enregistrée.</div><%
            break;
            case 2: %>
            <div class="info">Transaction annulée.</div><%
            break; } } %>
        </div>
    </body>
</html>
