    ...
    <body><% int p=5; %>
        ...
        <div class="contenu">
            ...
            break; } } else if(request.getAttribute("formulaire")!=null) {
                            EditForm1 formulaire=(EditForm1)(request.getAttribute("formulaire"));
                    //out.println(formulaire.getErrorMsg());
                            %>
                            <h1>Editer mon annonce "<%= formulaire.getTitreDefaut() %>"</h1><%
                            ...
                            <form action="./EditAnnonce1" method="POST">
